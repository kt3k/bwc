...
- すべてのピクセルアート (セル / アイテム / プロップ / アクター / エフェクト /
  ...
  パレット (`src/webview.ts` の `paletteColors`、不透明色 54 色)
  の色だけを使う。 一覧は `tools/palette.ts` にあり、それが正本。
- コード中で使う色 (エフェクト / UI の `#xxxxxx`) も同じパレットから選ぶ。
- `deno task check-palette` で `static/` 配下の全 PNG を検査できる。パレット外の
  色が 1 px でもあれば失敗する。素材を追加・変更したら必ず実行する
...
| 系統       | 明 → 暗                                                     |
| ---------- | ----------------------------------------------------------- |
| 白・グレー | `#ffffff` `#b9bcb9` `#6a6d6a` `#bec1be` `#4a4d4a` `#000000` |
| 青         | `#cceaff` `#68a5ff` `#1950c7` `#001480`                     |
| 藍         | `#dddeff` `#8c9cff` `#4b30e3` `#1f008a`                     |
| 紫         | `#ecdaff` `#b586ff` `#7322d6` `#38007a`                     |
| 赤紫       | `#f8d7fd` `#d975fd` `#951fa9` `#540056`                     |
| 桃         | `#fcd5f5` `#e377b9` `#9d285c` `#5a0019`                     |
| 橙・赤     | `#fcdbcf` `#e58d68` `#983600` `#4f1000`                     |
| 金・茶     | `#f9e7b5` `#d49d29` `#7f4b01` `#3d1c00`                     |
| 黄         | `#f1f0aa` `#b2af0d` `#5e6400` `#253200`                     |
| 黄緑       | `#dafaa9` `#7bc212` `#237601` `#013d00`                     |
| 緑         | `#c9febc` `#56c947` `#047e03` `#004000`                     |
